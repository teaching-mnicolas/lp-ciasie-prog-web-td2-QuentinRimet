describe ("Function Name", function() {
  ...
  it ("is problematic to use var name in recursion", function() {
    let wrapper = function() {
      ...
      expect(h()).toEqual(10);  // this line throw an exception, why ? g n'est plus une fonction donc return g()+1 ne peut plus marcher
    };
  ...
  it ("is better to use function name in recursion", function() {
    ...
    let h = g;
    g = 1;
    expect(h()).toEqual(10);  // explain why it works now ! car f est toujours une fonction
  });
